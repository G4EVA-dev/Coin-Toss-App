...
import { sendFormRequest } from "./dataSender";
...
const formVerfication = {
    checkInput_1Format(){
        ...
        if(verificationData.isNumber && verificationData.isLessThan20){
            ...
            formMethods.reableInputs(formData.formElements.formInput_2,formData.formElements.formInput_3)
        }else{
            verificationData.isInput_1Valid = false
            formMethods.displayErrorNotification(formData.formElements.errorDiv_1)
            formMethods.disableInputs(formData.formElements.formInput_2,formData.formElements.formInput_3)
        }
    },
    checkInput_2Format(){
        ...
        if(verificationData.isLetters && verificationData.isYesOrNo){
            ...
            formMethods.reableInputs(formData.formElements.formInput_1,formData.formElements.formInput_3)
        }else{
            verificationData.isInput_2Valid = false
            formMethods.displayErrorNotification(formData.formElements.errorDiv_2)
            formMethods.disableInputs(formData.formElements.formInput_1,formData.formElements.formInput_3)
        }
    },
    displaySubmitBtn(){
...
// form Event listeners (Everey Action after the 'change' event)
...
window.addEventListener('beforeunload',()=>{
    formMethods.resetInputs(formData.formElements.formInput_1,formData.formElements.formInput_2,formData.formElements.formInput_3)
})
